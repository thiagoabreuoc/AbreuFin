...
<div class="screen hidden" id="screen-account-data">
  ...
  <div class="screen-body p-3 app-body-rounded">
    <div class="card" id="account-data-card" style="border-radius:var(--md-sys-shape-corner-large)!important">
      <div class="card-body d-flex flex-column" style="gap:20px;padding:20px">
        <div class="d-flex align-items-start gap-2">
          ...
          <div>
            <div class="fw-semibold" style="font-size:.82rem">Nome</div>
            <div class="text-secondary small mt-1" id="ad-name">—</div>
          </div>
        </div>
        <div class="d-flex align-items-start gap-2">
          <span class="material-symbols-outlined text-secondary" style="font-size:1.1rem;margin-top:1px">mail</span>
          <div>
            <div class="fw-semibold" style="font-size:.82rem">E-mail</div>
            <div class="text-secondary small mt-1" id="ad-email">—</div>
          </div>
        </div>
        <div class="d-flex align-items-start gap-2">
          <span class="material-symbols-outlined text-secondary" style="font-size:1.1rem;margin-top:1px">key</span>
          <div>
            <div class="fw-semibold" style="font-size:.82rem">Método de login</div>
            <div class="text-secondary small mt-1" id="ad-login-method">—</div>
          </div>
        </div>
        <div class="d-flex align-items-start gap-2">
          <span class="material-symbols-outlined text-secondary" style="font-size:1.1rem;margin-top:1px">calendar_today</span>
          <div>
            <div class="fw-semibold" style="font-size:.82rem">Membro desde</div>
    ...
    <div class="card mt-4" id="account-biometric-card" style="border-radius:var(--md-sys-shape-corner-large)!important">
