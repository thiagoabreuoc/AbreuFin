...
<div class="screen hidden" id="screen-account-data">
  ...
  <div class="screen-body p-3">
    <div class="card" style="border-radius:var(--md-sys-shape-corner-large)!important">
      <div class="card-body d-flex flex-column" style="gap:20px;padding:20px">
        <div>
          ...
          <div class="fw-medium mt-1" id="ad-name">—</div>
        </div>
        <div>
          <div class="text-secondary small">E-mail</div>
          <div class="fw-medium mt-1" id="ad-email">—</div>
        </div>
        <div>
          <div class="text-secondary small">Método de login</div>
          <div class="fw-medium mt-1" id="ad-login-method">—</div>
        </div>
        <div>
          <div class="text-secondary small">Membro desde</div>
          <div class="fw-medium mt-1" id="ad-created-at">—</div>
        </div>
      </div>
    </div>
    ...
    <div class="mt-4" id="ad-google-section" style="display:none">
      ...
      <div class="d-flex align-items-start gap-2 mt-2 px-3 py-2" id="ad-unlink-hint-box" style="background:var(--md-extended-color-aviso-color-container);color:var(--md-extended-color-aviso-on-color-container);border-radius:var(--md-sys-shape-corner-medium)">
        <span class="material-symbols-outlined" style="font-size:1.1rem;flex-shrink:0;line-height:1.3">info</span>
