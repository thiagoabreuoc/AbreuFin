  ...
  <div class="screen-body p-3 app-body-rounded">
    <div class="text-center" style="padding:8px 8px 20px">
      ...
      <p class="text-secondary small mt-2 mb-0">
        O AbreuFin é mantido de forma independente. Se ele te ajuda a organizar suas finanças, considere fazer uma doação via Pix para cobrir os custos de manutenção.
      </p>
    </div>
