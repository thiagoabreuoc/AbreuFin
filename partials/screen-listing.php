...
<div class="screen hidden" id="screen-listing">
  ...
  <div class="screen-body app-body-rounded" style="padding:28px 16px 16px">
    ...
    <div class="mb-2" id="listing-filter-sort-row" style="display:flex;justify-content:space-between;align-items:center;gap:16px;padding-left:8px;padding-right:8px">
      ...
      <div style="display:flex;align-items:center;gap:16px">
        ...
        <div style="display:flex;align-items:center;gap:8px">
          <a href="#" id="sort-btn-vencido" class="text-decoration-none d-inline-flex align-items-center justify-content-center" style="padding:10px" onclick="sortEntries('vencido','asc');return false;" aria-label="Ordenar por vencidos" title="Vencido"><span class="m3-badge-small m3-badge-small-error"></span></a>
          <a href="#" id="sort-btn-vencendo" class="text-decoration-none d-inline-flex align-items-center justify-content-center" style="padding:10px" onclick="sortEntries('vencendo','asc');return false;" aria-label="Ordenar por a vencer" title="Vencendo"><span class="m3-badge-small m3-badge-small-warning"></span></a>
          <a href="#" id="sort-btn-neutro" class="text-decoration-none d-inline-flex align-items-center justify-content-center" style="padding:10px" onclick="sortEntries('neutro','asc');return false;" aria-label="Ordenar por sem vencimento próximo" title="Sem vencimento próximo"><span class="m3-badge-small m3-badge-small-neutral"></span></a>
        </div>
      </div>
    </div>
