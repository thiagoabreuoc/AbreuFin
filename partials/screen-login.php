...
<div class="screen active" id="screen-login">
  <div class="screen-body center-col">
    ...
    <div class="form-floating mb-3">
      <input class="form-control" id="l-email" type="email" placeholder="E-mail" autocomplete="email">
      <label for="l-email">E-mail</label>
    </div>
    <div class="form-floating mb-3">
      <input class="form-control" id="l-senha" type="password" placeholder="Senha" autocomplete="current-password">
    ...
    <div class="text-center small mt-4">
      <a href="#" onclick="showScreen('forgot');return false;">Esqueci minha senha</a>
      &nbsp;·&nbsp;
      <a href="#" onclick="showScreen('register');return false;">Criar conta</a>
    </div>
    <div class="text-center small mt-2">
      <a href="#" class="text-muted" onclick="showScreen('privacy');return false;">Política de Privacidade e LGPD</a>
    </div>
  </div>
</div>
