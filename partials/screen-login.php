...
<div class="screen hidden auth-screen" id="screen-login">
  ...
  <div class="screen-body center-col">
    ...
    <a href="api/google_login.php" class="d-flex align-items-center justify-content-between auth-input-box auth-google-card text-decoration-none mb-3" aria-label="Continuar com Google">
      <span class="fw-semibold" style="color:#000">Continuar com Google</span>
    ...
    <div class="mb-3 position-relative">
      <input class="form-control auth-input-box" id="l-senha" type="password" placeholder="Senha" autocomplete="current-password" style="padding-right:44px">
      <button type="button" class="btn btn-link p-0 position-absolute" style="right:14px;top:50%;transform:translateY(-50%);color:rgba(255,255,255,.85)" onclick="togglePwVisibility('l-senha', this)" aria-label="Mostrar senha" tabindex="-1">
