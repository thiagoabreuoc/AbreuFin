...
<div class="screen hidden" id="screen-profile">
  ...
  <div class="screen-body p-3 app-body-rounded">
    ...
    <div class="mb-4">
      <div class="profile-item d-flex align-items-center gap-3" onclick="showScreen('account-data');initAccountDataScreen();initBiometricSettings()">
    ...
    <hr style="margin:24px 40px;border-color:var(--md-sys-color-outline-variant);opacity:.6">
    ...
    <div class="text-center" style="padding-bottom:8px">
      ...
      <a href="https://wa.me/5521975745997" target="_blank" rel="noopener" class="d-inline-flex align-items-center gap-1 text-decoration-none fw-semibold" style="font-size:.85rem;color:var(--md-sys-color-primary);margin-top:6px">
