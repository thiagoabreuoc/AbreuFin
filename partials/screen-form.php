      ...
      <div id="cat-accordion-body" class="d-none" style="margin-top:12px">
        ...
        <fieldset class="form-box">
          ...
          <div id="f-categoria-custom-wrap" style="display:none" class="mt-2">
            ...
            <input type="text" class="form-control mt-2" id="f-categoria-custom-group" placeholder="Grupo (ex: Transporte)" list="f-categoria-group-options">
            <datalist id="f-categoria-group-options"></datalist>
