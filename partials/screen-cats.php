...
<div class="screen hidden" id="screen-cats">
  ...
  <div class="d-flex justify-content-center px-3 gap-2 flex-shrink-0 app-body-rounded" style="padding-top:24px;padding-bottom:4px">
  ...
  <div class="screen-body p-3" id="cats-body" style="padding-top:4px!important">
    <!-- rendered by JS -->
  </div>
</div>
