...
const MATERIAL_THEMES = {
  azul: {
    ...
    light: {
      ...
      '--md-sys-color-tertiary':'#98763e','--md-sys-color-on-tertiary':'#ffffff',
      '--md-sys-color-tertiary-container':'#f1e5d0','--md-sys-color-on-tertiary-container':'#513e1f',
    ...
    dark: {
      ...
      '--md-sys-color-tertiary':'#e6d6bc','--md-sys-color-on-tertiary':'#47381f',
      '--md-sys-color-tertiary-container':'#6b542e','--md-sys-color-on-tertiary-container':'#f4e9d7',
  ...
  roxo: {
    ...
    light: {
      ...
      '--md-sys-color-tertiary':'#7f983e','--md-sys-color-on-tertiary':'#ffffff',
      '--md-sys-color-tertiary-container':'#e8f1d0','--md-sys-color-on-tertiary-container':'#43511f',
      '--md-sys-color-error':'#ba1a1a','--md-sys-color-on-error':'#ffffff',
      '--md-sys-color-error-container':'#ffdad6','--md-sys-color-on-error-container':'#93000a',
    ...
    dark: {
      ...
      '--md-sys-color-tertiary':'#dae6bc','--md-sys-color-on-tertiary':'#3c471f',
      '--md-sys-color-tertiary-container':'#5a6b2e','--md-sys-color-on-tertiary-container':'#ecf4d7',
      '--md-sys-color-error':'#ffb4ab','--md-sys-color-on-error':'#690005',
      '--md-sys-color-error-container':'#93000a','--md-sys-color-on-error-container':'#ffdad6',
  ...
  oliva: {
    ...
    light: {
      ...
      '--md-sys-color-tertiary':'#583e98','--md-sys-color-on-tertiary':'#ffffff',
      '--md-sys-color-tertiary-container':'#d9d0f1','--md-sys-color-on-tertiary-container':'#2d1f51',
      '--md-sys-color-error':'#ba1a1a','--md-sys-color-on-error':'#ffffff',
      '--md-sys-color-error-container':'#ffdad6','--md-sys-color-on-error-container':'#93000a',
    ...
    dark: {
      ...
      '--md-sys-color-tertiary':'#c8bce6','--md-sys-color-on-tertiary':'#2a1f47',
      '--md-sys-color-tertiary-container':'#3f2e6b','--md-sys-color-on-tertiary-container':'#dfd7f4',
      '--md-sys-color-error':'#ffb4ab','--md-sys-color-on-error':'#690005',
      '--md-sys-color-error-container':'#93000a','--md-sys-color-on-error-container':'#ffdad6',
  ...
  marinho: {
    ...
    light: {
      ...
      '--md-sys-color-tertiary':'#986a3e','--md-sys-color-on-tertiary':'#ffffff',
      '--md-sys-color-tertiary-container':'#f1e0d0','--md-sys-color-on-tertiary-container':'#51371f',
      '--md-sys-color-error':'#ba1a1a','--md-sys-color-on-error':'#ffffff',
      '--md-sys-color-error-container':'#ffdad6','--md-sys-color-on-error-container':'#93000a',
    ...
    dark: {
      ...
      '--md-sys-color-tertiary':'#e6d1bc','--md-sys-color-on-tertiary':'#47321f',
      '--md-sys-color-tertiary-container':'#6b4c2e','--md-sys-color-on-tertiary-container':'#f4e5d7',
      '--md-sys-color-error':'#ffb4ab','--md-sys-color-on-error':'#690005',
      '--md-sys-color-error-container':'#93000a','--md-sys-color-on-error-container':'#ffdad6',
  ...
  vermelho: {
    ...
    light: {
      ...
      '--md-sys-color-tertiary':'#3e8b98','--md-sys-color-on-tertiary':'#ffffff',
      '--md-sys-color-tertiary-container':'#d0ecf1','--md-sys-color-on-tertiary-container':'#1f4a51',
      '--md-sys-color-error':'#ba1a1a','--md-sys-color-on-error':'#ffffff',
      '--md-sys-color-error-container':'#ffdad6','--md-sys-color-on-error-container':'#93000a',
      '--md-sys-color-background':'#fafaf9','--md-sys-color-on-background':'#1e1a1a',
      '--md-sys-color-surface':'#fafaf9','--md-sys-color-on-surface':'#1e1a1a',
    ...
    dark: {
      ...
      '--md-sys-color-tertiary':'#bce0e6','--md-sys-color-on-tertiary':'#1f4147',
      '--md-sys-color-tertiary-container':'#2e626b','--md-sys-color-on-tertiary-container':'#d7eff4',
      '--md-sys-color-error':'#ffb4ab','--md-sys-color-on-error':'#690005',
      '--md-sys-color-error-container':'#93000a','--md-sys-color-on-error-container':'#ffdad6',
  ...
  teal: {
    ...
    light: {
      ...
      '--md-sys-color-tertiary':'#983e44','--md-sys-color-on-tertiary':'#ffffff',
      '--md-sys-color-tertiary-container':'#f1d0d2','--md-sys-color-on-tertiary-container':'#511f22',
      '--md-sys-color-error':'#ba1a1a','--md-sys-color-on-error':'#ffffff',
      '--md-sys-color-error-container':'#ffdad6','--md-sys-color-on-error-container':'#93000a',
      '--md-sys-color-background':'#f9fafa','--md-sys-color-on-background':'#1a1e1e',
      '--md-sys-color-surface':'#f9fafa','--md-sys-color-on-surface':'#1a1e1e',
    ...
    dark: {
      ...
      '--md-sys-color-tertiary':'#e6bcbf','--md-sys-color-on-tertiary':'#471f21',
      '--md-sys-color-tertiary-container':'#6b2e32','--md-sys-color-on-tertiary-container':'#f4d7d9',
      '--md-sys-color-error':'#ffb4ab','--md-sys-color-on-error':'#690005',
      '--md-sys-color-error-container':'#93000a','--md-sys-color-on-error-container':'#ffdad6',
  ...
  mostarda: {
    ...
    light: {
      ...
      '--md-sys-color-tertiary':'#3e5898','--md-sys-color-on-tertiary':'#ffffff',
      '--md-sys-color-tertiary-container':'#d0d9f1','--md-sys-color-on-tertiary-container':'#1f2d51',
      '--md-sys-color-error':'#ba1a1a','--md-sys-color-on-error':'#ffffff',
      '--md-sys-color-error-container':'#ffdad6','--md-sys-color-on-error-container':'#93000a',
      '--md-sys-color-background':'#fafaf9','--md-sys-color-on-background':'#1e1d1a',
      '--md-sys-color-surface':'#fafaf9','--md-sys-color-on-surface':'#1e1d1a',
    ...
    dark: {
      ...
      '--md-sys-color-tertiary':'#bcc8e6','--md-sys-color-on-tertiary':'#1f2a47',
      '--md-sys-color-tertiary-container':'#2e3f6b','--md-sys-color-on-tertiary-container':'#d7dff4',
      '--md-sys-color-error':'#ffb4ab','--md-sys-color-on-error':'#690005',
      '--md-sys-color-error-container':'#93000a','--md-sys-color-on-error-container':'#ffdad6',
...
function themeCarouselItemHtml(key, t, active) {
  const accent = t.light['--md-sys-color-tertiary'];
  return `<div class="theme-carousel-item" data-theme-name="${key}" onclick="applyMaterialTheme('${key}')">
    <div class="theme-carousel-swatch${active ? ' active' : ''}" style="background:linear-gradient(135deg, ${t.swatch} 50%, ${accent} 50%)">${active ? '<span class="material-symbols-outlined">check</span>' : ''}</div>
